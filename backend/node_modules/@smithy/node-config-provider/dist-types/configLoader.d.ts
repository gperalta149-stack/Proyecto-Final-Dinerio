import type { EnvOptions, GetterFromEnv } from "@smithy/node-config-provider/dist-types/fromEnv";
import type { GetterFromConfig, SharedConfigInit } from "@smithy/node-config-provider/dist-types/fromSharedConfigFiles";
import type { FromStaticConfig } from "@smithy/node-config-provider/dist-types/fromStatic";
